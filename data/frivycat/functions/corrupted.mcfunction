...
execute as @e[type=ghast,team=Corrupted,tag=!aftercorrupt] run data merge entity @s {ExplosionPower:5}
execute as @e[type=vindicator,team=Corrupted,tag=!aftercorrupt] run data merge entity @s {Johnny:1}

execute as @e[team=Corrupted,tag=!aftercorrupt,type=!player,type=!bat] run data merge entity @s {DeathLootTable:"frivycat:entities/corrupted_drops"}
